...
class TransferView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            if sender_account.balance < amount:
                ...
                self.send_transfer_email(sender_account.user.email, recipient_account.user.email, amount)
    ...
    def send_transfer_email(self, sender_email, recipient_email, amount):
        subject = 'Bank Transfer Notification'
        message_sender = f'You have successfully transferred TK{amount}.'
        message_recipient = f'You have received TK{amount} in your account.'
